...
function rgbToLabJS(r, g, b) {
  ...
  const x = (rl * 0.4124564 + gl2 * 0.3575761 + bl * 0.1804375) / XN
  const y = (rl * 0.2126729 + gl2 * 0.7151522 + bl * 0.0721750) / YN
  const z = (rl * 0.0193339 + gl2 * 0.1191920 + bl * 0.9503041) / ZN
