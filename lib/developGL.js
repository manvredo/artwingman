...
export function initGL(canvas) {
  ...
  return { gl, canvas, vbo, progs, origTex, texA, texB, texC, colorGroupsTex, fboA, fboB, fboC, w: 1, h: 1, lutTex: null, lutSize: 0 }
}
...
export function uploadImage(state, imgEl) {
  ...
  for (const tex of [texA, texB, texC, colorGroupsTex]) {
