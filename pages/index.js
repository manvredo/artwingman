    ...
    <div className={styles.layout}>
      ...
      <div className={styles.rightArea}>
        ...
        <div className={styles.viewBtnStrip}>
          ...
          <button className={styles.viewBtn} onClick={() => { setLoupeMode(true); setShowMunsellValues(false) }} title="Lupe an/aus" style={{ color: loupeMode ? '#c8a96e' : '#555250' }}>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <circle cx="7" cy="7" r="4" stroke="currentColor" strokeWidth="1.5"/>
              <line x1="10" y1="10" x2="14" y2="14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
            </svg>
          </button>
          <button className={styles.viewBtn} onClick={() => { setShowMunsellValues(true); setLoupeMode(false) }} title="Munsell-Werte an/aus" style={{ color: showMunsellValues ? '#c8a96e' : '#555250' }}>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
